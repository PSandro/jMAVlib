...
public class RotationConversion {
    ...
    public static Float[] quaternionByEulerAngles(double x, double y, double z) {
        double cosPhi_2 = Math.cos(x / 2.0);
        double cosTheta_2 = Math.cos(y / 2.0);
        double cosPsi_2 = Math.cos(z / 2.0);
        double sinPhi_2 = Math.sin(x / 2.0);
        double sinTheta_2 = Math.sin(y / 2.0);
        double sinPsi_2 = Math.sin(z / 2.0);
        return new Float[]{
